...
def full_strain(x, dof):
    ...
    base = np.zeros([6, dof])
    # if dof % 2 == 1:
    # if even: linear torsion
    # if odd: constant torsion
    # 5/6 -> linear
    # 7/8 -> quadratic
    base[0, 0] = 1  # torsion
    base[1, 1] = 1  # y-bending
    base[1, 2] = x  # linear y-bending
    base[2, 3] = 1  # z-bending
    base[2, 4] = x  # linear z-bending

    # base[0, 0] = 1  # torsion
    # base[0, 1] = x  # linear torsion
    # base[1, 2] = 1  # y-bending
    # base[1, 3] = x  # linear y-bending
    # base[1, 4] = x ** 2  # quadratic y-bending
    # base[2, 5] = 1  # z-bending
    # base[2, 6] = x  # linear z-bending
    # base[2, 7] = x ** 2  # quadratic z-bending
    return base
