...
def main():
    ...
    # interactive?? todo
    optimize_result.best_solver.visualize_best_solution(objects_file, output_path)  # save picture todo
    optimize_result.best_solver.visualize_best_solution_path(objects_file, output_path)  # save movie todo
